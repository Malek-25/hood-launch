...
contract MockERC20 {
    string public constant name = "Mock HOODIE";
    string public constant symbol = "HOODIE";
    ...
    function _transfer(address from, address to, uint256 amount) private { require(balanceOf[from] >= amount, "BALANCE"); unchecked { balanceOf[from] -= amount; } balanceOf[to] += amount; emit Transfer(from, to, amount); }
}
